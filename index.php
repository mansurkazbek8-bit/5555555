...
<body>
  ...
  <div id="content">
    <!-- Заголовок -->
    <h1><?= $header?></h1>
    <?php if (!$hasVisitCookie): ?>
      <p>Спасибо, что зашли на огонек</p>
    <?php else: ?>
      <p>
        Вы зашли к нам <?= htmlspecialchars((string) $visitCounter, ENT_QUOTES, 'UTF-8') ?> раз<br />
        Последнее посещение: <?= htmlspecialchars($lastVisit, ENT_QUOTES, 'UTF-8') ?>
      </p>
    <?php endif; ?>
    <!-- Заголовок -->
